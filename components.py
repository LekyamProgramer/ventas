...
class Menu:
    def __init__(self,titulo : str ="",opciones: str =[],col=6,fil=1) -> None:
        self.titulo: str =titulo
        self.opciones: int =opciones
        self.col: int =col
        self.fil: int =fil
...
class Valida:
    def solo_numeros(self,mensajeError: str,col: int,fil: int) -> None:
        while True: 
            gotoxy(col,fil)            
            valor = input()
            try:
    ...
    def solo_letras(self,mensaje: str,mensajeError: str)-> None: 
        while True:
    ...
    def solo_decimales(self,mensaje: str,mensajeError: str)-> None:
        while True:
            valor = str(input("          ------>   | {} ".format(mensaje)))
            try:
                valor = float(valor)
    ...
    def cedula(self, mensaje: str, mensajeError: str)-> None:
        while True:
            valor = str(input("          ------>   | {} ".format(mensaje)))
            try:
                valor.isdigit and valor
                if valor > float(0):
                    break
            except:
                print("          ------><  | {} ".format(mensajeError))
